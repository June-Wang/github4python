...
for i in range(days-1,90,-1):
	...
	p_change_15 = get_p_change_for_days(get_day(10,i))
	p_change_20 = get_p_change_for_days(get_day(15,i))
	p_change_30 = get_p_change_for_days(get_day(20,i))
	p_change_40 = get_p_change_for_days(get_day(30,i))
	p_change_60 = get_p_change_for_days(get_day(40,i))
	p_change_90 = get_p_change_for_days(get_day(60,i))
	...
	p_change_title = 'change(1/3/5/15/20/30/60/90):\t'
	p_change_msg = get_color(("%.2f" % p_change))+'\t'+get_color(("%.2f" % p_change_3))+'\t'+get_color(("%.2f" % p_change_5))+'\t'+get_color(("%.2f" % p_change_15))+'\t'+get_color(("%.2f" % p_change_20))+'\t'+get_color(("%.2f" % p_change_30))+'\t'+get_color(("%.2f" % p_change_40))+'\t'+get_color(("%.2f" % p_change_90))
	...
	elif (p_change < 0 and p_change_3 > 0 and p_change_5 > 9 and p_change_15 >0 and p_change_20 >0 and p_change_30 >0 and p_change_60 >0) or (p_change < 0 and p_change_3 > 0 and p_change_5 > 0 and p_change_15 >0 and p_change_20 >0 and p_change_30 >0 and p_change_60 >0 and p_change_90<15 and p_change_90 >10):
	#elif p_change_90 > 20:
