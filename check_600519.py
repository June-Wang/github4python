...
for i in range(days-1,90,-1):
    ...
    change_list = (p_change,p_change_3,p_change_5,p_change_10,p_change_15,p_change_20,p_change_30,p_change_60,p_change_90)
    p_change_msg = ''
    for change_f in change_list:
        p_change_msg = p_change_msg + get_color(("%.2f" % change_f))+'\t'
