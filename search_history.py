...
for code in rows:
	...
	stock_name = str(basics[basics.index == stock_code][['name']].values[0][0])
	...
	for i in range(days-1,days-2,-1):
		...
		if p_change < 0 and day_data[3] < 0 and day_data[5] <0 and day_data[10] < 0 and day_data[15] < 0  and day_data[20] < 0 and day_data[30] < 0 and day_data[60] < 0 and day_data[90] < 0 and day_data[120] <0:
			print(Fore.CYAN+stock_code+' '+stock_name+'\t'+date_now+' '+price_msg+' '+p_change_title+Style.RESET_ALL+p_change_msg)
			...
			print(Fore.YELLOW+stock_code+' '+stock_name+'\t'+date_now+' '+price_msg+' '+p_change_title+Style.RESET_ALL+p_change_msg)
		#elif p_change > 0:
		#	print(Fore.RED+stock_code+' '+stock_name+'\t'+date_now+' '+price_msg+' '+p_change_title+Style.RESET_ALL+p_change_msg)
		#elif p_change < 0:
		#	print(Fore.GREEN+stock_code+' '+stock_name+'\t'+date_now+' '+price_msg+' '+p_change_title+Style.RESET_ALL+p_change_msg)
		#else:
